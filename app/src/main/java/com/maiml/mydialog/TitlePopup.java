...
public class TitlePopup extends PopupWindow {
    ...
    public void showCenter(View view) {
        ...
        /*showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING
				- (getWidth() / 2), mRect.bottom);*/
        showAtLocation(view, Gravity.NO_GRAVITY, mLocation[0] + 150, mRect.bottom - 30);
    ...
    private void populateActions() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView textView = BaseViewHolder.get(convertView, R.id.txt_title);
